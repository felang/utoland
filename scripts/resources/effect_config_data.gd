...
@export var bullet_trail_width: float = 4.0
...
@export var shuriken_trail_width: float = 6.0
@export var shuriken_trail_color: Color = Color(0.2, 0.8, 1.0, 0.6)
@export var shuriken_return_rotation_mult: float = 1.5
@export var shuriken_return_distance: float = 15.0

# 激光特效
@export var laser_beam_width: float = 6.0
@export var laser_beam_color: Color = Color(1, 0.2, 0.2, 0.9)
@export var laser_beam_hitbox_height: float = 16.0
